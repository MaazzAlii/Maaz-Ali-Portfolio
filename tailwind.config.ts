  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "display-2": ["clamp(1.875rem, 3.5vw, 2.75rem)", { lineHeight: "1.08", letterSpacing: "-0.02em" }],
      },
      maxWidth: {
        content: "72rem",
      },
      ...
      backgroundImage: {
        "radial-fade": "radial-gradient(ellipse 70% 50% at 50% -10%, var(--accent-glow), transparent)",
      },
      keyframes: {
        marquee: {
